...
class ELMoBiLSTMExperiment_2(ELMoPreTrainBaseExperiment):
    ...
    def build_model_classifier(self, run_number=0):
        ...
        self.classifier_model = Model(inputs=input_model, outputs=output_layer, name="ELMo_BiLSTM_Classifier_V2")
