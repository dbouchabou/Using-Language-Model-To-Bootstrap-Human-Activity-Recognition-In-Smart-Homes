...
class Word2vecBiLSTMExperiment(Word2VecPreTrainBaseExperiment):
    ...
    def build_model_classifier(self, run_number=0):
        ...
        lstm_1 = Bidirectional(LSTM(output_dim))(token_emb)

        output_layer = Dense(nb_classes, activation='softmax')(lstm_1)

        self.classifier_model = Model(inputs=feature_1, outputs=output_layer, name="W2V_BiLSTM_Classifier")
