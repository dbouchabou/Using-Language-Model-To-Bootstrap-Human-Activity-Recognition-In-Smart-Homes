...
class BiLSTM2LExperiment(Experiment):
    ...
    def build_model_classifier(self, run_number=0):
        ...
        lstm_1 = Bidirectional(LSTM(output_dim, return_sequences=True))(embedding)
        lstm_2 = Bidirectional(LSTM(output_dim))(lstm_1)

        output_layer = Dense(nb_classes, activation='softmax')(lstm_2)

        self.classifier_model = Model(inputs=feature_1, outputs=output_layer, name="BiLSTM_Embedding_2L")
